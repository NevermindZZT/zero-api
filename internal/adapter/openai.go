...
var modelDB = map[string]*ModelInfo{
	...
	"gpt-5.4-nano":        {ID: "gpt-5.4-nano", Name: "GPT-5.4 Nano", ContextWindow: 400000, MaxOutputTokens: 128000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"gpt-5.4-pro":         {ID: "gpt-5.4-pro", Name: "GPT-5.4 Pro", ContextWindow: 1048576, MaxOutputTokens: 128000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"gpt-5.5":             {ID: "gpt-5.5", Name: "GPT-5.5", ContextWindow: 1048576, MaxOutputTokens: 128000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"gpt-5.5-pro":         {ID: "gpt-5.5-pro", Name: "GPT-5.5 Pro", ContextWindow: 1048576, MaxOutputTokens: 128000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"gpt-5.3-codex-spark": {ID: "gpt-5.3-codex-spark", Name: "GPT-5.3 Codex Spark", ContextWindow: 128000, MaxOutputTokens: 128000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"gpt-5.3-codex":       {ID: "gpt-5.3-codex", Name: "GPT-5.3 Codex", ContextWindow: 400000, MaxOutputTokens: 128000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"gpt-image-2":         {ID: "gpt-image-2", Name: "GPT Image 2", SupportsVision: true, Protocols: []string{"openai"}, Capabilities: []string{"image_generation", "image_editing"}, InputModalities: []string{"text", "image"}, OutputModalities: []string{"image"}},
	"gpt-image-1.5":       {ID: "gpt-image-1.5", Name: "GPT Image 1.5", SupportsVision: true, Protocols: []string{"openai"}, Capabilities: []string{"image_generation", "image_editing"}, InputModalities: []string{"text", "image"}, OutputModalities: []string{"image"}},
	...
	"gemini-3.1-flash-lite":  {ID: "gemini-3.1-flash-lite", Name: "Gemini 3.1 Flash Lite", ContextWindow: 1048576, MaxOutputTokens: 65536, SupportsThinking: true, SupportsTools: true, SupportsVision: true},
	"gemini-3.5-flash":       {ID: "gemini-3.5-flash", Name: "Gemini 3.5 Flash", ContextWindow: 1048576, MaxOutputTokens: 65536, SupportsThinking: true, SupportsTools: true, SupportsVision: true},
	...
	"gemini-3-flash-preview": {ID: "gemini-3-flash-preview", Name: "Gemini 3 Flash Preview", ContextWindow: 1048576, MaxOutputTokens: 65536, SupportsThinking: true, SupportsTools: true, SupportsVision: true},
	// MiniMax
	...
	"grok-4.6":                    {ID: "grok-4.6", Name: "Grok 4.6", ContextWindow: 500000, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"grok-4.3":                    {ID: "grok-4.3", Name: "Grok 4.3", ContextWindow: 1048576, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
	"grok-build-0.1":              {ID: "grok-build-0.1", Name: "Grok Build 0.1", ContextWindow: 262144, SupportsVision: true, SupportsThinking: true, SupportsTools: true},
